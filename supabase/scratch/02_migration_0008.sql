-- SCRATCH BUNDLE 2 of 4 — migration 0008 ONLY
-- Run SECOND, as its own execution. Adds the admin_role value 'admin'.
-- MUST NOT share a transaction with 0009, which uses that value.
